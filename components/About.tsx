...
const About = () => {
    return (
        <section className="about mt-20 md:mt-40 text-center py-10 md:py-20 ">
            ...
            <div className="block md:flex w-3/4 m-auto justify-center items-top gap-16 py-10">
                <div className="flex flex-col text-center justify-between items-center py-6 md:py-0">
                    ...
                    <p className="text-base md:text-xl  text-[#D9D9D9]">Imagine having a companion that wants to support you throughout every step of your mental health journey whenever  you want. We’re  here to be that friend.</p>
                </div>
                <div className="flex flex-col text-center justify-between items-center py-6 md:py-0">
                    ...
                    <p className="text-base md:text-xl text-[#D9D9D9]">By creating a network of professionals and putting together clinically and researched backed tools and resources, we want to support you to get a healthier mind.</p>
                </div>
                <div className="flex flex-col text-center justify-between items-center py-6 md:py-0">
                    ...
                    <p className="text-base md:text-xl text-[#D9D9D9]">We believe that mental health is very important and everyone, no matter their background deserves access to quality mental health care. </p>
                </div>
            </div>
        </section>
    )
