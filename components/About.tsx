    ...
    return (
        <section className="about mt-10 text-center py-14 ">
            <div className='md:w-3/5 m-auto'>
                <h2 className="heading text-4xl xl:text-6xl font-bold text-white">
                    About us
                </h2>
                <p className="about-para text-2xl md:text-4xl xl:text-6xl font-bold text-white pt-16 px-6 md:p-14">
